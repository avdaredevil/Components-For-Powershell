...
"Factorial|f","Combination|c","Permutations|p","Power|pw" | % {Write-AP-Wrapper -noSign ("x!{0}({1})" -f $_.split("|"));if ($_[-1]-ne"w"){Write-AP-Wrapper -nosign "x*, "}else{Write-AP-Wrapper -nosign "*]"}}
